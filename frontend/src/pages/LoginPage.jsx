...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-tripify-dark">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-primary-600 via-primary-500 to-emerald-400 pt-12 pb-24 px-6 flex-shrink-0">
        {/* Back button */}
        <button
          onClick={() => navigate('/')}
        ...
        <div className="relative z-10 flex flex-col items-center text-center mt-4">
          ...
          <h1 className="font-display font-bold text-4xl text-white tracking-tight">Tripify</h1>
          <p className="text-white/70 text-sm mt-2 font-medium">Plan smarter. Travel better.</p>
        </div>
      </div>
      ...
      <div className="flex-1 relative -mt-10 z-10">
        <div className="bg-white dark:bg-tripify-dark rounded-t-[2rem] shadow-[0_-8px_40px_rgba(0,0,0,0.12)] px-6 pt-8 pb-12 max-w-md mx-auto w-full min-h-full">
          ...
          <h2 className="font-display font-bold text-2xl text-gray-900 dark:text-white">Welcome back 👋</h2>
          <p className="text-gray-400 dark:text-gray-500 text-sm mt-1 mb-7">Sign in to continue your journey</p>

          {/* Redirect message from planner */}
          {redirectMessage && !error && (
            <div className="mb-5 p-3.5 bg-primary-50 dark:bg-primary-900/20 border border-primary-100 dark:border-primary-800 rounded-2xl text-sm text-primary-700 dark:text-primary-400 flex items-center gap-2">
              <span>✈️</span> {redirectMessage}
            </div>
          )}
